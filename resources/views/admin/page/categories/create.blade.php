                                    ...
                                    <div class="row clearfix">
                                                ...
                                                <select id="parent_id" name="parent_id"
                                                    ...
                                                    @foreach ($parentCategories as $parentCategory)
                                                        ...
                                                        @if($parentCategory->children->count()>0)
                                                            ...
                                                            <option class="pr-2"
                                                                    {{ old('parent_id') == $childCategory->id ? "selected":null}}
                                        ...
                                        <div class="col-lg-3 col-md-4 col-sm-6">
                                            ...
                                            <div class="switchToggle">
                                                <input type="checkbox" name="is_active" id="switch" {{$errors->any() && old('is_active') ? 'checked':null}}>
                                        ...
                                        <div class="col-lg-3 col-md-4 col-sm-6">
                                            ...
                                            <div class="form-group">
                                                <select id="attributesId" name="attribute_ids[]"
                                                        ...
                                                        data-placeholder="انتخاب ویژگی" multiple
                                        ...
                                        <div class="sub-feature col-lg-3 col-md-4 col-sm-6 align-self-center">
                                            <div class="checkbox">
                                                <input id="check" {{ old('is_show') ==='on' ? 'checked' : '' }}
