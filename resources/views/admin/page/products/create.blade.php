            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="card">
                        ...
                        <div class="body">
                            <form id="form_advanced_validation" action="{{ route('admin.products.store') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="row clearfix">
                                    <div class="form-group col-md-12">
                                        ...
                                        <textarea class="form-control" id="summernote" required name="description">{!! old('description') !!}</textarea>
                                        @error('description')
                                        <span class="text-danger m-0">{{$message}}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="row clearfix">
                                    <div class="col-sm-6">
                                        ...
                                        <div class="form-group">
                                            <input dir="ltr" required class="form-control without-spin" id="delivery_amount" name="delivery_amount" type="number" value="{{ old('delivery_amount') }}">
                                    ...
                                    <div class="col-sm-6">
                                        <label for="delivery_amount_per_product"> هزینه ارسال به ازای محصول
                                            اضافی*</label>
                                        <div class="form-group">
                                            <input dir="ltr" class="form-control without-spin" id="delivery_amount_per_product" name="delivery_amount_per_product" type="number" value="{{ old('delivery_amount_per_product') }}">
                            ...
                            <div class="col-lg-12 col-md-12">
                                ...
                                <div class="form-group">
                                    <form action="{{route('admin.uploade')}}" id="myDropzone" class="dropzone" method="POST" id="my-awesome-dropzone">
                                        @csrf
                                    </form>
                                </div>
                            </div>
