                                            ...
                                            <div class="nav-account d-block pl">
                                                ...
                                                <div class="dropdown-menu">
                                                    <ul class="account-uls mb-0">
                                                        ...
                                                        <li class="account-item">
                                                            <a href="{{route('home.user_profile')}}" class="account-link">پنل
                                                                کاربری</a>
                                                        </li>
                                                        <li class="account-item">
                                ...
                                <li id="nav-menu-item" class="menu-item nav-overlay pl-3">
                                    ...
                                    <ul class="sub-menu is-mega-menu mega-menu-level-two">
                                        ...
                                        <li class="menu-mega-item menu-item-type-mega-menu">
                                            <a href="{{route('home.products.search',['slug'=>$category->slug])}}" class="mega-menu-link">
                                                {{$category->name}}
                                            </a>
                                        ...
                                        <li class="menu-mega-item menu-item-type-mega-menu pr-2">
                                            <img src="{{url(env('BANNER_IMAGES_PATCH').$menue_banner->image)}}" alt="{{$menue_banner->title}}">
                                        </li>
                                        @endif
