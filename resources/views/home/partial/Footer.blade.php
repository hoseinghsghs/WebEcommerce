                    ...
                    <div class="footer-more-info mb-2">
                        ...
                        <div class="col-lg-3 col-md-4 pl">
                            <div class="licences d-flex mx-auto">
                                <div class="ml-1">
                                    <img referrerpolicy='origin' id='rgvjnbqeesgtesgtjxlzwlao' style='cursor:pointer'
                                         onclick='window.open("https://logo.samandehi.ir/Verify.aspx?id=320014&p=xlaouiwkobpdobpdrfthaods", "Popup","toolbar=no, scrollbars=no, location=no, statusbar=no, menubar=no, resizable=0, width=450, height=630, top=30")'
                                         alt='logo-samandehi'
                                         src='https://logo.samandehi.ir/logo.aspx?id=320014&p=qftiodrflymalymanbpdshwl'/>
                                </div>
                                <div>
                                    <a referrerpolicy="origin" target="_blank"
                                       href="https://trustseal.enamad.ir/?id=306946&amp;Code=zXLWtyHj1hfgbjnHBLOv"><img
                                            referrerpolicy="origin"
                                            src="https://Trustseal.eNamad.ir/logo.aspx?id=306946&amp;Code=zXLWtyHj1hfgbjnHBLOv"
                                            alt="" style="cursor:pointer" id="zXLWtyHj1hfgbjnHBLOv"></a>
                                </div>
                            </div>
                        </div>
                    </div>
