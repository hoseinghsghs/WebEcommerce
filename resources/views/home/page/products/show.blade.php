                                                    ...
                                                    <li class="Three-dimensional">
                                                        <a href=""
                                                           data-product="{{$product->id}}"
                                                            @class(["btn-option btn-compare","text-primary"=>session()->has('compareProducts') && in_array($product->id,session()->get('compareProducts'))])>
                                                                ...
                                                                <div class="col-lg-8 col-md-8 col-xs-12 pr">
                                                                    <select name="variation" id="var-select"
                                                                        ...
                                                                        @endphp @foreach($var as $variation )
                                                                            <option
                                                                                value="{{ json_encode($variation->only(['id' , 'sku' ,'guarantee' ,'time_guarantee' , 'quantity','is_sale' , 'sale_price' , 'price'])) }}" {{ $variationProductSelected->id == $variation->id ? 'selected' : '' }}>
                                                                                {{$variation->value}}
                                                                            </option>
                                                                        @endforeach
                                                                    </select>
                        ...
                        <div class="tab-content" id="myTabContent">
                            ...
                            <div class="tab-pane fade {{ count($errors) > 0 ? 'show active' : '' }}"
                                ...
                                <div class="faq">
                                    ...
                                    <div
                                        id="product-questions-list"> @foreach ($product->approvedQuestions as $question )
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-12 col-12 mb-3">
                                                        ...
                                                        <input type="range" class="quality form-control-range"
                                                               name="quality" id="formControlRange" min="1" max="5"
                                                               step="1" onInput="setlable('quality')">
                                                    </div>
                                                    <center>
