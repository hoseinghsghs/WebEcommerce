                ...
                <div id="breadcrumb">
                    ...
                    <nav aria-label="breadcrumb" class="p-1">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item"><a href="{{route('home.products.search',$product->category->parent->slug)}}">{{$product->category->parent->name}}</a>
                            </li>
                            <li class="breadcrumb-item"><a href="{{route('home.products.index',$product->category->slug)}}">
                                    ...
                                    <div class="product-directory">
                                        <ul>
                                            ...
                                            <li>
                                                ...
                                                @foreach ($product->tags as $tag ) <a href="{{route('home.products.search',['tag'=>$tag->name])}}" class="product-link product-tag-title">{{$tag->name}} ،</a>
                                                @endforeach
                                            </li>
                                            @endif
                                            @if ($product->brand)
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-8 col-md-8 col-xs-12 pr">
                                                            <select name="variation" id="var-select" style="display: inline; width: 75%;" class="select-var form-control form-control-sm" id="varition">
                                                                ...
                                                                <option value="{{ json_encode($variation->only(['id' , 'sku' ,'guarantee' ,'time_guarantee' , 'quantity','is_sale' , 'sale_price' , 'price'])) }}" {{ $variationProductSelected->id == $variation->id ? 'selected' : '' }}>
                                                                    {{$variation->value}}
                                                                </option>
                                                                @endforeach
                                                            </select>
                                            ...
                                            <div class="seller-info-changable">
                                                ...
                                                <div class="product-seller-row price">
                                                    ...
                                                    <a class="product-name variation-price">
                                                        @if ($product->quantity_check) @if ($product->sale_check)
                                                        <div class="amount">
                                                ...
                                                @if ($product->quantity_check) <input type="hidden" id="product_id" name="product" value="{{$product->id}}">
                    ...
                    <div class="tab-content" id="myTabContent">
                                                    ...
                                                    <section>
                                                        <div class="comments-user-shopping mt-3 mr-1 p-2 row">
                                                            ...
                                                            <div class="col-6">
                                                                ...
                                                                </div> <span data-rating-stars="5" data-rating-readonly="true" data-rating-value="{{ceil($comment->commentable->rates->avg('satisfaction'))}}">
                                                                </span>
                                                            </div>
                                                        </div>
                                                    </section>
                        ...
                        <div class="tab-pane fade {{ count($errors) > 0 ? 'show active' : '' }}" id="question-and-answer" role="tabpanel" aria-labelledby="question-and-answer-tab">
                            <div class="faq">
                                ...
                                @endforeach
                                @endif <form action="{{route('home.questions.store' , ['product' => $product->id])}}" method="POST" class="review-form">
                                    @csrf
