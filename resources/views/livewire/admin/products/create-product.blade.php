                ...
                <div class="body">
                        ...
                        <div class="form-group col-md-3 col-sm-6 @error('position') is-invalid @enderror">
                            ...
                            <div wire:ignore>
                                <select id="positionSelect" name="position"
                                        ...
                                        class="form-control ms select2 @error('position') is-invalid @enderror">
                    ...
                    <div class="row clearfix">
                        <div class="form-group col-sm-4 @error('category_id') is-invalid @enderror">
                            <label for="categorySelect"><i wire:loading class='zmdi zmdi-hc-fw zmdi-hc-spin'></i>
                                دسته بندی*</label>
                            <div wire:ignore>
                    ...
                    @if($category_id && $category_attributes && $category_variation)
                        ...
                        <div id="attributesContainer">
                            ...
                            <p>ویژگی متغییر برای <span id="variationName"
                                ...
                                <button class="btn btn-sm btn-info" type="button" wire:click="addVariation">افزودن
                                </button>
                            </p>
                            <!-- ویژگی های متغییر -->
