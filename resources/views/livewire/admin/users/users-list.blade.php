                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center js-sweetalert">
                                <a onclick="loadbtn(event)" href="{{route('admin.users.show',$user->id)}}" class="btn btn-light waves-effect waves-float btn-sm waves-green">
                                    <i class="zmdi zmdi-eye"></i>
                                </a>
                                <a href="{{route('admin.users.edit',$user->id)}}" class="btn btn-light waves-effect waves-float btn-sm waves-green" onclick="loadbtn(event)">
