...
return [
    'meta' => [
        ...
        'defaults'       => [
            ...
            'description'  => 'فروشگاه اینترنتی لایکوشاپ با فراهم آوردن بستری ایمن ،امکان خرید مستقیم از تولید کننده  و با مناسب ترین قیمت را برای کاربران ایجاد کرده است.', // set false to total remove
            'separator'    => ' - ',
