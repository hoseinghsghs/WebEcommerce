            ...
            <section class="page-account-box">
                <div class="col-lg-6 col-md-10 col-xs-12 mx-auto">
                    <div class="ds-userlogin">
                        <a href="<?php echo e(route('home')); ?>" class="account-box-logo" style="background: url(<?php echo e(asset('storage/logo/'.$setting->logo)); ?>) no-repeat;background-size: contain;"><?php echo e($setting->title); ?></a>
                                    ...
                                    <form id="login-with-pass" class="form-account" style="display: none;">
                                        ...
                                        <div class="text-right">
                                            ...
                                            <div class="form-auth-row d-flex">
                                                ...
                                                <div class="mr-auto">
                                                    <a class="account-link-password" onclick="otpLogin(event)">ورود با رمز یکبار مصرف</a>
                                                    <br>
                                                    <a class="account-link-password" onclick="setUsername()" data-toggle="modal" data-target="#resetModal">رمز خود
                                                        را فراموش کرده ام</a>
                                                </div>
                                            </div>
                                            <div class="form-row-account">
                                        ...
                                        <div class="message-light">
                                            ...
                                            <div class="account-box-verify-content">
                                                <div class="form-account">
                                                    <div class="form-account-title">کد فعال سازی پیامک شده را وارد کنید
                                                    </div>
                    ...
                    <div class="account-box-content">
                        ...
                        <form id="forget-password-form" autocomplete="off" class="form-account text-center">
                            <div class="form-account-title text-right">
                                ...
                                <input type="text" id="username-reset" class="number-email-input form-control" placeholder="لطفا ایمیل یا شماره  موبایل خود را وارد کنید" oninvalid="this.setCustomValidity('این فیلد الزامی است')" oninput="this.setCustomValidity('')" required>
...
<script src="<?php echo e(asset('assets/home/js/vendor/jquery.countdown.js')); ?>"></script>
<script>
    let otp_id;
    ...
    $('#auth-form').submit(function(event) {
        ...
        $.post("<?php echo e(route('authenticate')); ?>", {
    ...
    $('#verify-otp-code').submit(function(event) {
        ...
        $.post("<?php echo e(route('otp.verify')); ?>", {
                '_token': "<?php echo e(csrf_token()); ?>",
                'otp_code': code,
                'id': otp_id,
            },
            function(response, status) {
                ...
                window.location.replace("<?php echo e(Redirect::intended('/')->getTargetUrl()); ?>");
    ...
    function resendOtp(event, counterId) {
        ...
        $.post("<?php echo e(route('otp.resend')); ?>", {
                '_token': "<?php echo e(csrf_token()); ?>",
                'id': otp_id,
            },
            function(response, status) {
    ...
    $('#forget-password-form').submit(function(event) {
        ...
        if (isNaN(input)) {
            $.post("<?php echo e(route('password.email')); ?>", {
                    '_token': "<?php echo e(csrf_token()); ?>",
                    'email': input,
                },
                function(response, status) {
            ...
            $.post("<?php echo e(route('authenticate')); ?>", {
                ...
                function(response, status) {
                    ...
                    $('#verify-otp-code-reset .message-sended').html(`برای شماره همراه <strong>${input}</strong> کد تایید ارسال گردید`)
                    //set timer
                    var secondsToAdd = response.time_to_expire;
                    var currentDate = new Date();
                    var futureDate = new Date(currentDate.getTime() + secondsToAdd * 1000);
        ...
        $('#reset-password').submit(function(event) {
            ...
            $.post("<?php echo e(route('otp.resetPassword')); ?>", {
                    '_token': "<?php echo e(csrf_token()); ?>",
...
<?php echo $__env->make('home.layout.MasterHome', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/public_html/WebEcommerce/resources/views/home/auth/login.blade.php ENDPATH**/ ?>