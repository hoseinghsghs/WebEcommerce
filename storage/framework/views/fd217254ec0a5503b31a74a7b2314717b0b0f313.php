                ...
                <div class="col-lg-3 col-md-6 col-sm-12">
                    <div class="card widget_2 big_icon traffic">
                        <div class="body">
                            ...
                            <h2><?php echo e($successsend_order); ?><small class="info"> از <?php echo e($all_order); ?> </small></h2>
                            <small> <?php echo e((int)(($successsend_order/($all_order>0 ? $all_order : 1))*100)); ?>% تراکنش
                                موفق </small>
                            <div class="progress">
                                <div class="progress-bar l-amber" role="progressbar" aria-valuenow="45"
                                    aria-valuemin="0" aria-valuemax="<?php echo e($all_order); ?>"
                                    style="width: <?php echo e(($successsend_order/($all_order>0 ? $all_order : 1))*100); ?>%;"></div>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-12">
                    <div class="card widget_2 big_icon sales">
                        <div class="body">
                            ...
                            <h2><?php echo e($successpay_order); ?> <small class="info">از <?php echo e($all_order); ?></small></h2>
                            <small><?php echo e((int)(($successpay_order/($all_order>0 ? $all_order : 1))*100)); ?>% سفارشات آماده
                                برای ارسال</small>
                            <div class="progress">
                                <div class="progress-bar l-blue" role="progressbar" aria-valuenow="38" aria-valuemin="0"
                                    aria-valuemax="<?php echo e($all_order); ?>"
                                    style="width: <?php echo e(($successpay_order/($all_order>0 ? $all_order : 1))*100); ?>%;"></div>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-12">
                    <div class="card widget_2 big_icon email">
                        <div class="body">
                            ...
                            <h2><?php echo e($returned_order); ?> <small class="info">از <?php echo e($all_order); ?></small></h2>
                            <small> <?php echo e((int)(($returned_order/($all_order>0 ? $all_order : 1))*100)); ?>% سفارشات
                                مرجوعی</small>
                            <div class="progress">
                                <div class="progress-bar l-purple" role="progressbar" aria-valuenow="39"
                                    aria-valuemin="<?php echo e($all_order); ?>" aria-valuemax="100"
                                    style="width: <?php echo e(($returned_order/($all_order>0 ? $all_order : 1))*100); ?>%;"></div>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-12">
                    <div class="card widget_2 big_icon domains">
                        <div class="body">
                            ...
                            <h2><?php echo e($notpay_order); ?> <small class="info">از <?php echo e($all_order); ?></small></h2>
                            <small><?php echo e((int)(($notpay_order/($all_order>0 ? $all_order : 1))*100)); ?>% در انتظار
                                پرداخت</small>
                            <div class="progress">
                                <div class="progress-bar l-green" role="progressbar" aria-valuenow="89"
                                    aria-valuemin="0" aria-valuemax="<?php echo e($all_order); ?>"
                                    style="width: <?php echo e(($notpay_order/($all_order>0 ? $all_order : 1))*100); ?>%;"></div>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card widget_2 big_icon ">
                        <div class="body">
                            <div class="d-flex justify-content-between">
                                <div>
                                    <h6><?php echo e(number_format( $amunt_success_orders)); ?> تومان</h6>
                ...
                <div class="col-lg-3 col-md-6 col-sm-12">
                    <div class="card widget_2 big_icon">
                        <div class="body">
                            <div class="d-flex justify-content-between">
                                <div>
                                    <h6><?php echo e(number_format($amunt_coupon_orders)); ?> تومان</h6>
                ...
                <div class="col-lg-3 col-md-6 col-sm-12">
                    <div class="card widget_2 big_icon">
                        <div class="body">
                            <div class="d-flex justify-content-between">
                                <div>
                                    <h6><?php echo e(number_format($amunt_delivery_orders)); ?> تومان</h6>
                    ...
                    <div class="card widget_2 big_icon">
                        <div class="body">
                            <div class="state_w1 mb-1 mt-1">
                                <div class="d-flex justify-content-between">
                                    <div>
                                        <h6><?php echo e(number_format($amunt_total_orders)); ?> تومان</h6>
...
function initC3Chart() {
    month_visits = "<?php echo e(json_encode($month_visits)); ?>";
    month_visits = JSON.parse(month_visits);
    if ("<?php echo e(json_encode($month_visits)); ?>" === "[0]") {} else {
    ...
    setTimeout(function() {
        $success = <?php echo json_encode($successTransactions, 15, 512) ?>;
        $unsuccess = <?php echo json_encode($unsuccessTransactions, 15, 512) ?>;
        month_visits = "<?php echo e(json_encode($month_visits)); ?>";
        month_visits = JSON.parse(month_visits);
        $(document).ready(function() {
            var chart = c3.generate({
...
<script>
$(document).ready(function() {
    more_1 = <?php echo json_encode($more[0], 15, 512) ?>;
    more_2 = <?php echo json_encode($more[1], 15, 512) ?>;
    more_3 = <?php echo json_encode($more[2], 15, 512) ?>;
...
<?php echo $__env->make('admin.layout.MasterAdmin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/public_html/WebEcommerce/resources/views/admin/page/dashboard.blade.php ENDPATH**/ ?>